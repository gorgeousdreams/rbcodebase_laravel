...
@section('content')
<div class="col-xs-12">
	{{ Form::open(['route' => 'admin.actor.user.role.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-role']) }}
		...
		<div class="box box-success">
			<div class="box-body">
								...
								<div class="col-xs-12">
									@if ($permissions->count())
										@foreach ($permissions as $perm)
											<input type="checkbox" name="permissions[]" value="{{ $perm->id }}" id="perm_{{ $perm->id }}" /> <label for="perm_{{ $perm->id }}">{{ $perm->title }}</label><br/>
										@endforeach
									@else
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						{{ Form::text('order', ($role_count+1), ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.roles.sort')]) }}
					</div><!--col-lg-10-->
				</div><!--form control-->
			</div><!-- /.box-body -->
		</div><!--box-->
