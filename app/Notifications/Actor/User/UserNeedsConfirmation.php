...
namespace App\Notifications\Actor\User;
 ...
 * @package App\Notifications\Actor\User
 */
class UserNeedsConfirmation extends Notification
{
	...
	public function toMail($notifiable)
	{
		return (new MailMessage)
			...
			->action(trans('buttons.emails.auth.confirm_account'), route('actor.user.auth.confirm', $this->confirmation_code))
