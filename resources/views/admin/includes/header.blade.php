<header class="main-header">
	...
	<a href="{{ route('common.dashboard') }}" class="logo">
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						<li class="user-header">
							...
							<p>
								{{-- access()->user()->name }} - {{ implode(", ", access()->user()->roles->pluck('name')->toArray()) --}}
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="{!! route('common.dashboard') !!}" class="btn btn-default btn-flat">
									<i class="fa fa-home"></i>
									{{ trans('navs.general.home') }}
								</a>
							</div>
							<div class="pull-right">
								<a href="{!! route('actor.user.auth.logout') !!}" class="btn btn-danger btn-flat">
