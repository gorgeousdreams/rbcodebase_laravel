...
@section('content')
	...
	<div class="col-xs-12 search-form m-b-20">
	...
	<div class="col-xs-12 search-results">
		...
		<p><small>Searching in {{ $target }}</small></p>
		...
		<h2>Users</h2>
			...
			<div class="result">
				<h3 class="m-b-10"><a href="{!! route('actor.user.profile.show', $user->name_slug) !!}">{!! $user->getDisplayName() !!}</a> </h3>
				...
				<p class="description">Public user profile for {!! $user->getDisplayName() !!}</p>
			</div>
			@endforeach
		@endif
